       ...
       <form action="/data-kabupaten" method="POST">
        ...
        @endif
                ...
                <div class="card-body">
                    ...
                    <h5>Data Kelurahan yang Belum Terupdate per <strong>{{$tanggalSekarang}}</strong> <a href="#" id="expandable">Lihat detail</a></h5>
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">Pelaku Perjalanan Luar Negeri</label>
                        <input type="number" name="ppln" class="form-control" placeholder="Jumlah PP-LN" required>
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">Pelaku Perjalanan Dalam Negeri</label>
                        <input type="number" name="ppdn" class="form-control" placeholder="Jumlah PP-DN" required>
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">Transmisi Lokal</label>
                        <input type="number" name="tl" class="form-control" placeholder="Jumlah Transimisi Lokal" required>
                    </div>
